...
{
    [Description("销售变更单保存控制业务模式")]
    [Kingdee.BOS.Util.HotUpdate]
    public class YBG_Save_SAL_XORDER : AbstractOperationServicePlugIn
    {
        /// <summary>
        /// 定制加载指定字段到实体里<p>
        /// </summary>
        ...
        public override void OnPreparePropertys(Kingdee.BOS.Core.DynamicForm.PlugIn.Args.PreparePropertysEventArgs e)
        {
            ...
            e.FieldKeys.Add("F_YBG_Supplier");//供应商
            ...
            try
            {
                ...
                if (e.DataEntitys != null && e.DataEntitys.Count<DynamicObject>() > 0)
                {
                    ...
                    foreach (DynamicObject item in e.DataEntitys)
                    {
                        ...
                        //供应商
                        string F_YBG_Supplier = item["F_YBG_Supplier_Id"].ToString();
                        //仓库
                        ...
                        sql = string.Format(@"select FBILLNO  from T_SAL_ORDER a inner join T_PUR_POORDERENTRY_R c on c.FSRCBILLNO=a.FBILLNO
                                    where FBILLNO='{0}'", sArray[0]);
                        ...
                        if (!string.IsNullOrEmpty(soFBILLNO))
                        {
                            ...
                            {
                                throw new Exception("变更失败：未填写仓库或供应商！");
                            }
                            else
                            {
                                //仓库编码
                           ...
                           {
                                throw new Exception("销售订单变更后业务模式改变了，不能保存！" );
                           }
                        }
